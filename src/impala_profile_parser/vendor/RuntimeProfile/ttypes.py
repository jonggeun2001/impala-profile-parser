...
import impala_profile_parser.vendor.ExecStats.ttypes
import impala_profile_parser.vendor.Metrics.ttypes
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.exec_summary = impala_profile_parser.vendor.ExecStats.ttypes.TExecSummary()
...
TRuntimeProfileTree.thrift_spec = (
    ...
    (2, TType.STRUCT, 'exec_summary', [impala_profile_parser.vendor.ExecStats.ttypes.TExecSummary, None], None, ),  # 2
