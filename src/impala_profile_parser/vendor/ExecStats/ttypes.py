...
import impala_profile_parser.vendor.Status.ttypes
import impala_profile_parser.vendor.Types.ttypes
...
class TExecStats(object):
    ...
    def __init__(self, latency_ns=None, cpu_time_ns=None, cardinality=None, memory_used=None, last_batch_returned=None,):
        self.latency_ns = latency_ns
        self.cpu_time_ns = cpu_time_ns
        self.cardinality = cardinality
        self.memory_used = memory_used
        self.last_batch_returned = last_batch_returned
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.last_batch_returned = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.memory_used is not None:
            ...
            oprot.writeFieldEnd()
        if self.last_batch_returned is not None:
            oprot.writeFieldBegin('last_batch_returned', TType.BOOL, 5)
            oprot.writeBool(self.last_batch_returned)
            oprot.writeFieldEnd()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.status = impala_profile_parser.vendor.Status.ttypes.TStatus()
...
TExecStats.thrift_spec = (
    ...
    (5, TType.BOOL, 'last_batch_returned', None, None, ),  # 5
)
...
TExecSummary.thrift_spec = (
    ...
    (2, TType.STRUCT, 'status', [impala_profile_parser.vendor.Status.ttypes.TStatus, None], None, ),  # 2
