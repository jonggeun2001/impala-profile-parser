...
class TStructField(object):
    ...
    def __init__(self, name=None, comment=None, field_id=None, is_nullable=None,):
        self.name = name
    ...
    def write(self, oprot):
        ...
        if self.is_nullable is not None:
            oprot.writeFieldBegin('is_nullable', TType.BOOL, 4)
...
class TIcebergDeletionVector(object):
    """
    Attributes:
     - path
     - content_offset
    ...
    def __init__(self, path=None, content_offset=None, content_size_in_bytes=None, record_count=None,):
        self.path = path
        self.content_offset = content_offset
        self.content_size_in_bytes = content_size_in_bytes
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I64:
                    self.content_offset = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.I64:
                    self.content_size_in_bytes = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I64:
                    self.record_count = iprot.readI64()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TIcebergDeletionVector')
        if self.path is not None:
            oprot.writeFieldBegin('path', TType.STRING, 1)
            oprot.writeString(self.path)
            oprot.writeFieldEnd()
        if self.content_offset is not None:
            oprot.writeFieldBegin('content_offset', TType.I64, 2)
            oprot.writeI64(self.content_offset)
            oprot.writeFieldEnd()
        if self.content_size_in_bytes is not None:
            oprot.writeFieldBegin('content_size_in_bytes', TType.I64, 3)
            oprot.writeI64(self.content_size_in_bytes)
            oprot.writeFieldEnd()
        if self.record_count is not None:
            oprot.writeFieldBegin('record_count', TType.I64, 4)
            oprot.writeI64(self.record_count)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.content_offset is None:
            raise TProtocolException(message='Required field content_offset is unset!')
        if self.content_size_in_bytes is None:
            raise TProtocolException(message='Required field content_size_in_bytes is unset!')
        return
...
TStructField.thrift_spec = (
    ...
    (4, TType.BOOL, 'is_nullable', None, None, ),  # 4
)
...
all_structs.append(TIcebergDeletionVector)
TIcebergDeletionVector.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'path', None, None, ),  # 1
    (2, TType.I64, 'content_offset', None, None, ),  # 2
    (3, TType.I64, 'content_size_in_bytes', None, None, ),  # 3
    (4, TType.I64, 'record_count', None, None, ),  # 4
)
